...
<script lang="ts">
	...
	const searchOptions = [
		...
		},
		{
			...
			icon: '👥',
			href: '/dashboard/management/customer-search',
			color: '#16a34a'
		},
		{
			title: 'LSPs',
			description: 'Search logistics service providers',
			icon: '🚚',
			href: '/dashboard/management/lsp-search',
			color: '#7c3aed'
		},
		{
			title: 'Airlines',
			description: 'Search airline information',
			icon: '✈️',
		...
		{
			title: 'Jobs',
			description: 'Search and manage job orders',
			icon: '📋',
			href: '/dashboard/operations/jobsearch',
			color: '#ea580c'
		}
	]
</script>
...
CCCCCC EEEEEEE RR   RR   TT     UUUUU   SSSSS</pre>
		...
		<div class="system-title">
			<span class="red-text">MANAGEMENT PORTAL - SEARCH</span>
		</div>
		...
		{#if user && userProfile}
			<div class="user-info">
				...
				<p class="blue-text">Function: SEARCH ENTITIES</p>
			</div>
		{/if}

		<!-- Selection Grid -->
		<div class="selection-section">
			<h3 class="blue-text">--- SELECT WHAT TO SEARCH ---</h3>
			<p class="selection-subtitle">Choose the type of entity you want to search for</p>
		...
		<div class="command-prompt">
			<span class="red-text">([MGMT] Search Selection - Choose Entity Type)</span>
		</div>
